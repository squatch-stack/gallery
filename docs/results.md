...
| springhouse-outside | place | not applicable | unavailable | unavailable | 26,858,880 | FAIL (web-mobile) | unavailable | unavailable |
| brookline-station-2 | object | 436,384 | not applicable | not applicable | 5,798,118 | PASS (web-mobile) | unavailable | unavailable |
| cannon | object | 159,755 | not applicable | not applicable | 2,248,387 | PASS (web-mobile) | unavailable | unavailable |
| cannon-mesh | object | not applicable | unavailable | unavailable | 17,549,488 | PASS (web-mobile) | unavailable | unavailable |
| oak | object | 480,000 | not applicable | not applicable | 6,760,418 | PASS (web-mobile) | --crop-quantile 0.60 --crop-margin 1.1 --alpha-min 0.05 --scale-ceiling 0.05 --target-count 480000 | candidate |
...
Generated at: 2026-09-04 22:22:17 UTC
