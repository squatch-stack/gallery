...
| saguaro | place | 480,000 | not applicable | not applicable | 5,557,453 | PASS (web-mobile) | --center=-0.4807,-1.1365,-1.7104 --crop-radius 8 --crop-shape cylinder --up=0.0183,0.9976,0.0669 --alpha-min 0.02 --target-count 480000 | candidate |
...
| wilsons-creek-gun | object | 460,973 | not applicable | not applicable | 6,152,323 | PASS (web-mobile) | --center 0.8494,0.1580,-0.6501 --crop-radius 2.5 --crop-shape ellipsoid --alpha-min 0.10 --scale-ceiling 0.008 | candidate |
| redrock-cairn | object | 422,702 | not applicable | not applicable | 5,643,619 | PASS (web-mobile) | --center=-0.4463,0.0835,-0.3115 --crop-radius 2.5 --crop-shape ellipsoid --alpha-min 0.10 --scale-ceiling 0.008 | candidate |
...
Generated at: 2026-09-06 01:38:25 UTC
