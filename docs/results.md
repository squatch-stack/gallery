...
|---|---|---:|---:|---|---|---|
| brookline-station | place | 480,000 | 6,302,790 | PASS (web-mobile) | --alpha-min 0.02 --crop-quantile 0.90 --crop-margin 1.4 --scale-ceiling 0.05 --target-count 480000 | candidate |
| springhouse-outside | place | 0 | 26,858,880 | FAIL (web-mobile) | unavailable | unavailable |
| brookline-station-2 | object | 436,384 | 5,798,118 | PASS (web-mobile) | unavailable | unavailable |
| cannon | object | 159,755 | 2,248,387 | PASS (web-mobile) | unavailable | unavailable |
| cannon-mesh | object | 0 | 17,549,488 | PASS (web-mobile) | unavailable | unavailable |
| oak | object | 480,000 | 6,760,418 | PASS (web-mobile) | --crop-quantile 0.60 --crop-margin 1.1 --alpha-min 0.05 --scale-ceiling 0.05 --target-count 480000 | candidate |
| research-library | place | 631,726 | 8,316,921 | FAIL (web-mobile) | unavailable | unavailable |
| wilsons-creek | place | 480,000 | 6,384,325 | PASS (web-mobile) | --alpha-min 0.02 --crop-quantile 0.90 --crop-margin 1.4 --scale-ceiling 0.05 --target-count 480000 | candidate |
| redrock | place | 480,000 | 6,324,827 | PASS (web-mobile) | --alpha-min 0.02 --crop-quantile 0.90 --crop-margin 1.4 --scale-ceiling 0.05 --target-count 480000 | candidate |
| saguaro | place | 480,000 | 5,640,538 | PASS (web-mobile) | --alpha-min 0.02 --crop-quantile 0.90 --crop-margin 1.4 --scale-ceiling 0.05 --target-count 480000 | candidate |
...
Generated at: 2026-09-04 21:48:26 UTC
